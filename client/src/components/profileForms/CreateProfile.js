...
const CreateProfile = ({ register,profile:{profile},getProfile }) => {
...
export default connect(mapStatetoProps, { register,getProfile })(CreateProfile);
